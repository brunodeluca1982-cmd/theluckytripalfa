...
export const festasData: FestaEvent[] = [
  {
    ...
    description: "Uma experiência 'show + festa': vários artistas nacionais em diferentes momentos do dia. Line up confirmado: Cabelinho, Veigh, Filipe Ret.",
    music: "Hip-hop, pop, pagode, rap, funk e hits do momento.",
  },
  {
    id: "adorofrozen-2026",
    ...
    neighborhood: "Centro",
    tag: "openbar",
    location: "Estrada das Furnas, 3800",
    gmapsUrl: "https://www.google.com/maps/search/?api=1&query=Estrada%20das%20Furnas%203800%20Rio%20de%20Janeiro",
    description: "Clássica festa open bar carnavalesca que costuma durar a madrugada inteira.",
    music: "Open format, pop, funk e hits de Carnaval.",
  },
  {
    ...
    tag: "glamour",
    location: "Copacabana Palace — Av. Atlântica, 1702 (Copacabana)",
    gmapsUrl: "https://www.google.com/maps/search/?api=1&query=Avenida%20Atl%C3%A2ntica%201702%20Copacabana%20Rio%20de%20Janeiro",
    description: "Festa icônica clássico-glamour do Carnaval carioca.",
    music: "Open format com brasilidades e hits.",
  },
  {
    ...
    location: "Cidade das Artes — Av. das Américas, 5300 (Barra da Tijuca)",
    gmapsUrl: "https://www.google.com/maps/search/?api=1&query=Avenida%20das%20Am%C3%A9ricas%205300%20Barra%20da%20Tijuca%20Rio%20de%20Janeiro",
    description: "Segundo dia do festival CarnaRildy. Festival indoor grande.",
  ...
  },
  {
    ...
    gmapsUrl: "",
    description: "Festa temática tradicional no calendário de Carnaval. Noite inteira.",
    music: "Open format.",
  },
  {
