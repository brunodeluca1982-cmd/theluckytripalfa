...
export const carnivalBlocks: CarnivalBlock[] = [
  // ── 16 de fevereiro — segunda ─────────────────────────────────
  {
    ...
    tag: "energético",
    address: "Leblon",
    shortDescription: "Bloco energético no Leblon.",
    time: "07:00",
    howToGetShort: "metrô Antero de Quental e caminhada.",
    audienceShort: "jovens e adultos.",
    musicShort: "pop e eletrônico.",
  ...
  },
  {
    ...
    neighborhood: "Urca",
    neighborhoodShort: "Urca",
    tag: "intimista",
    address: "Urca",
    shortDescription: "Bloco intimista e charmoso na Urca.",
    time: "08:00",
    howToGetShort: "metrô Botafogo + Uber curto.",
    audienceShort: "adultos.",
    musicShort: "MPB e samba.",
    missing_fields: ["concentration", "route", "dispersal", "vibe_details", "music_style", "structure", "end_time", "my_take"],
  },
  {
    id: "fica-comigo",
    ...
    name: "Fica Comigo",
    neighborhood: "Lagoa",
    neighborhoodShort: "Lagoa",
    tag: "familiar",
    address: "Lagoa",
    shortDescription: "Bloco familiar e descontraído na Lagoa.",
    time: "09:00",
    howToGetShort: "metrô Botafogo + Uber curto.",
    audienceShort: "famílias.",
    musicShort: "pop brasileiro.",
    missing_fields: ["concentration", "route", "dispersal", "vibe_details", "music_style", "structure", "end_time", "my_take"],
  },
  {
    id: "carvalho-em-pe",
    ...
    name: "Carvalho em Pé",
    neighborhood: "Tijuca",
    neighborhoodShort: "Tijuca",
    tag: "tradicional",
    address: "Tijuca",
    shortDescription: "Bloco tradicional na Tijuca.",
    time: "10:00",
    howToGetShort: "metrô Saens Peña e caminhada.",
    audienceShort: "adultos.",
    musicShort: "samba.",
    missing_fields: ["concentration", "route", "dispersal", "vibe_details", "music_style", "structure", "end_time", "my_take"],
  },
  {
    ...
    tag: "animado",
    address: "Copacabana",
    shortDescription: "Bloco animado e intenso em Copacabana.",
    time: "14:00",
    howToGetShort: "metrô Siqueira Campos/Cantagalo.",
    audienceShort: "jovens e adultos.",
    musicShort: "funk e samba.",
    missing_fields: ["concentration", "route", "dispersal", "vibe_details", "music_style", "structure", "end_time", "my_take"],
  },
