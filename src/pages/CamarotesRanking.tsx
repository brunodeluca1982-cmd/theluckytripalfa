  ...
  return (
    <div className="min-h-screen bg-[hsl(30,10%,8%)] text-[hsl(40,15%,92%)] pb-28">
            ...
            {cat.camarotes.map((cam, idx) => (
              ...
              >
                <div className="flex items-baseline gap-2 mb-1.5">
                  <span className="text-[11px] font-mono text-[hsl(40,25%,50%)]">
                    #{idx + 1}
                  </span>
                ...
                <p className="text-[13px] leading-relaxed text-[hsl(40,10%,58%)] font-sans">
                  {cam.reason}
                </p>
      ...
      <section className="px-4 mt-10">
        <h2
          className="text-lg font-semibold tracking-tight px-1 mb-4"
          style={{ fontFamily: "var(--font-serif)" }}
        >
          Atalho de Decisão
        </h2>
