...
const CalendarioCarnaval = () => {
  ...
  return (
    <div className="h-screen relative overflow-hidden pb-20">
      ...
      <div className="relative z-30 flex items-center justify-between px-4 pt-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            style={{
              backgroundColor: "hsla(141, 73%, 42%, 0.25)",
              color: "hsla(141, 73%, 72%, 1)",
            }}
      ...
      {/* Glass buttons — same style as Rio home */}
      <div className="relative z-20 px-6 flex flex-col gap-2 mt-2 overflow-y-auto max-h-[calc(100vh-280px)] pb-4">
        {days.map((day) => (
          <Link
            key={day.date}
